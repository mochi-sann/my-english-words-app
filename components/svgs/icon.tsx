...
export function EntypoPlus(props: SVGProps<SVGSVGElement>) {
  // プラスアイコン
  return (
    <svg
      focusable="false"
...
export function TopcoatPlus(props: SVGProps<SVGSVGElement>) {
  // プラスアイコン
  return (
    <svg
      focusable="false"
...
export function TopcoatMinus(props: SVGProps<SVGSVGElement>) {
  // マイナスアイコン
  return (
    <svg
      focusable="false"
